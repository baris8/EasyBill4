...
document_id = 'document_id_example' # str | Filter stock entries by document id. (optional)
    ...
    try:
        # Fetch a list of stock entries for positions
        api_response = api_instance.stocks_get(limit=limit, page=page, position_id=position_id, document_id=document_id)
        pprint(api_response)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Fetch an stock entry for a position
        api_response = api_instance.stocks_id_get(id)
        pprint(api_response)
    except ApiException as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.StockApi(api_client)
    body = openapi_client.Stock() # Stock | 

    try:
        # Create a stock entry for a position
        api_response = api_instance.stocks_post(body)
        pprint(api_response)
    except ApiException as e:
